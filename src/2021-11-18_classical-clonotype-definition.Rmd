...
expand.grid(names_v,names_j) %>%
  as.data.frame() %>%
  dplyr::rename(V_gene = Var1, J_gene = Var2) %>%
  ...
  theme(axis.text.x = element_text(angle = 90, size = 4, hjust = 1, vjust = 0.5, face = "bold"),
